...
<link href="../assets/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <style>
      body{
        background-image: url("sekolah awal.jpg");
      }
      .bd-placeholder-img {
        font-size: 1.125rem;
        text-anchor: middle;
...
<main class="form-signin w-100 m-auto">
  <form>
    ...
    <button class="w-100 btn btn-lg btn-primary" type="submit" href="home.php">Sign in</button>
    <br>
...
<nav class="navbar navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
      <a class="navbar-brand" href="#"><img src="gambar.png" alt="60px" width="40px"></a>
